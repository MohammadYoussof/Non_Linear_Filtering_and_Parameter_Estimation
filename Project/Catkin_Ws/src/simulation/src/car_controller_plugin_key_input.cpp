...
#include <hmetc_plugins/SimJoystickAndKeyboard.h>
#include <math.h>
#include <algorithm>
...
class CCarControllerPluginKey : public ModelPlugin
{
		...
		public: void velSub(const hmetc_plugins::SimJoystickAndKeyboard::ConstPtr &_msg)
		{		
		...
		public: virtual void Load(physics::ModelPtr _model, sdf::ElementPtr _sdf)
		{
			...
			steering_joints_key[0] = _model->GetJoint("HMETC::hyundai::back_left_wheel_joint");
			steering_joints_key[1] = _model->GetJoint("HMETC::hyundai::back_right_wheel_joint");
			steering_joints_key[2] = _model->GetJoint("HMETC::hyundai::front_left_steering_joint");
			steering_joints_key[3] = _model->GetJoint("HMETC::hyundai::front_right_steering_joint");
			steering_joints_key[4] = _model->GetJoint("HMETC::hyundai::front_left_wheel_joint");
			steering_joints_key[5] = _model->GetJoint("HMETC::hyundai::front_right_wheel_joint");
			...
			ros::SubscribeOptions so =ros::SubscribeOptions::create<hmetc_plugins::SimJoystickAndKeyboard>
			...
			this->wheel_publisher = ros_node1->advertise<std_msgs::Float32> ( "/sc_vehsteerdata",1000 );
		...
		private: hmetc_plugins::SimJoystickAndKeyboard msgs1;
